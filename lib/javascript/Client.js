...
function jgi_mg_assembly(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.run_mg_assembly_pipeline = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "jgi_mg_assembly.run_mg_assembly_pipeline",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "jgi_mg_assembly.status",
